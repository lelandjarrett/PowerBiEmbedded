...
namespace active_directory_aspnetcore_webapp_openidconnect_v2.Services
{
    ...
    public class PbiEmbedService
    {
        ...
        public PbiEmbedService(AadService aadService, GraphServiceClient graphServiceClient)
        {
        ...
        /// <remarks>This function is n
        /// ot supported for RDL Report</remakrs>
        /// 
        ...
        // This needs to  be a public Async to be able to grab the username and pass it as the effective Identity
        // OR pass the value of the logged in user
        ...
        public EmbedToken GetEmbedToken(Guid reportId, IList<Guid> datasetIds, [Optional] Guid targetWorkspaceId)
        {
            ...
            var tokenRequest = new GenerateTokenRequestV2(
                ...
                identities: new List<EffectiveIdentity>() { new EffectiveIdentity("test",
